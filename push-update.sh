...
if [ ! -f "$1" ]; then
   ...
   echo
   echo "The name of ZIP is assumed to have awaken-VERSION-DATE-TYPE-* as format"
...
# Assume awaken-VERSION-DATE-TYPE-*.zip
...
adb shell "killall com.awaken.updater 2>/dev/null"
adb shell "sqlite3 /data/data/com.awaken.updater/databases/updates.db" \
